...
describe("#Notifications", () => {
  ...
  describe("#When displayDrawer is true and listNotifications is not empty", () => {
    ...
    test('that markNotificationAsRead function is called with the right ID', async () => {
      ...
      // Check if the function was called with the correct ID (assuming ID is 1 for this notification)
